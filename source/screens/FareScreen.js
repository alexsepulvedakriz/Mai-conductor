            ...
            if (userBooking.val()) {
                ...
                if (flag == true) {
                    ...
                    this.setState({ modalVisible: false }, () => {
                        const pickUp = { lat: this.state.region.wherelatitude, lng: this.state.region.wherelongitude, add: this.state.region.whereText };
                        const drop = { lat: this.state.region.droplatitude, lng: this.state.region.droplongitude, add: this.state.region.droptext };
