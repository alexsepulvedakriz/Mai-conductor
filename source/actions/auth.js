...
export const userSignInSuccess = (authUser) => {return {type: SIGN_IN_USER_SUCCESS, payload: authUser}};
export const userSignInFailed = (authUser) => {return {type: SIGN_IN_USER_FAILED, payload: authUser}};
